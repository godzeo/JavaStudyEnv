...
public class enCode {
    public static void main(String[] args) throws IOException {
        FileInputStream fileInputStream = new FileInputStream("/Users/zy/Desktop/fastjson1224/target/classes/com/bcel/Command.class");
